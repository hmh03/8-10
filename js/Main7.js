                        ...
                        <View style={{ marginLeft: 20, marginVertical: 4 }}>
                            <View style={{ flexDirection: 'row', marginVertical: 10 }}>
                                ...
                                <View style={{ gap: 10, flexDirection: 'row' }}>
                                    ...
                                    <TouchableOpacity
                                        style={{ backgroundColor: 'pink', borderRadius: 6, height: 25, width: 25 }}
                                    ></TouchableOpacity>
                                    <TouchableOpacity
                                        style={{ backgroundColor: 'black', borderRadius: 6, height: 25, width: 25 }}
                                    ></TouchableOpacity>
                                </View>
                            </View>
            ...
            <View style={{ borderWidth: 1, borderColor: '#979797' }}>
                <View style={{ marginHorizontal: 30, marginVertical: 20 }}>
                    ...
                    <TouchableOpacity style={{ backgroundColor: 'black', alignItems: 'center', borderRadius: 10 }}>
                        <Text style={{ fontSize: 20, color: 'white', fontWeight: 700, marginVertical: 10 }}>
                            CONTINUE
                        </Text>
                    </TouchableOpacity>
                </View>
